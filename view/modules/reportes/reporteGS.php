...
function Header()
{
    ...
    $this->Cell(10);
    // Título
    $this->Cell(160,10,'Reporte de salidas ',1,0,'C');
    // Salto de línea
    $this->Ln(10);

   
    $this->Cell(60,10,'Codigo de salida',1,0,'C',0);
	$this->Cell(60,10,'Fecha',1,0,'C',0);
	$this->Cell(60,10,'Cantidad total',1,1,'C',0);
}
...
while ($row=$resultado->fetch_assoc()) {
	$pdf->Cell(60,10,$row['COD_SALIDA'],1,0,'C',0);
	$pdf->Cell(60,10,$row['FECHA'],1,0,'C',0);
	$pdf->Cell(60,10,$row['CANTIDAD_TOTAL'],1,1,'C',0);
